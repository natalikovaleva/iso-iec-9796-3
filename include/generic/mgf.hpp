...
private:
    ...
    ByteSeq getMGF1(const ManagedBlob & source, const size_t octets_count) const;
    ByteSeq getMGF2(const ManagedBlob & source, const size_t octets_count) const;
public:
    ...
    inline ByteSeq operator() (const ManagedBlob & source, const size_t octets_count) const
        {
            switch(_Type)
            {
                case MGF1: return getMGF1(source, octets_count);
